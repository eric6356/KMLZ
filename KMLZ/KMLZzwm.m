...
-(instancetype)init{
    ...
    if (self) {
        self.sections = [[NSArray alloc]initWithObjects:
                         ...
                         nil];
        self.sectionTitle = [[NSArray alloc]initWithObjects:
                            @"梁惠王章句上",
                            @"梁惠王章句下",
                            @"公孙丑章句上",
                            @"公孙丑章句下",
                            ...
                            @"尽心章句下",
                            nil];
        self.pvArray = [[NSArray alloc]initWithObjects:
                        @"\t孟子见梁惠王。王曰：“叟不",
                        @"\t孟子见梁惠王，王立于沼上，",
                        @"\t梁惠王曰：“寡人之于国也，",
                        @"\t梁惠王曰：“寡人愿安承教。",
        ...
        self.zwArray = [[NSArray alloc]initWithObjects:
                        ...
                        @"\t淳于髡曰：“男女授受不亲，礼与？”<br />　　孟子曰：“礼也。”<br />　　曰：“嫂溺则援之以手乎？”<br />　　曰：“嫂溺不援，是豺狼也。男女授受不亲，礼也；嫂溺援之以手者，权也。”<br />　　曰：“今天下溺矣，夫子之不援，何也？”<br />　　曰：“天下溺，援之以道；嫂溺，援之以手。子欲手援天下乎？”\n",
                        ...
                        @"\t齐宣王问卿。孟子曰：“王何卿之问也？”<br />　　王曰：“卿不同乎？”曰：“不同。有贵戚之卿，有异姓之卿。”<br />　　王曰：“请问贵戚之卿。”曰：“君有大过则谏，反覆之而不听，则易位。”王勃然变乎色。<br />　　曰：“王勿异也。王问臣，臣不敢不以正对。”王色定，然后请问<br />　　异姓之卿。<br />　　曰：“君有过则谏，反覆之而不听，则去。”\n",
